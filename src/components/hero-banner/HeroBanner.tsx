  ...
  return (
    <div>
      <div className="relative z-10 bg-[url('/hero_image.jpg')] h-[80vh] w-screen lg:h-[85vh] bg-no-repeat bg-cover bg-bottom bg-blend-overlay bg-neutral-800">
        <Header />
        <div className="absolute -z-10 w-full px-5 font-medium flex gap-8 flex-col justify-center h-full items-center lg:px-0">
          <AnimatedSection direction={{ initial_x: 0, initial_y: 100 }}>
            <h2 className="max-w-md text-3xl leading-[56px]  text-center lg:leading-[70px] text-[#f2f2f2] lg:max-w-[750px] lg:text-6xl pb-10">
